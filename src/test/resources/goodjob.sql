...
insert into PORTFOLIO_DEV(normal_id, dev_cat_num) values('qqqq', 214);
insert into PORTFOLIO_DEV(normal_id, dev_cat_num) values('miri', 215);
insert into PORTFOLIO_DEV(normal_id, dev_cat_num) values('hsj', 214);
