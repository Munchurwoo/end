...
update company_member set num_of_employees=nvl('30', (select num_of_employees from company_member where company_id='Tmaxuser'))
where company_id='Tmaxuser' and '30' is not null

update company_member set num_of_employees=null where company_id='Tmaxuser'
...
insert into COMPANY_MEMBER(company_id, introduction, company_type, industry, sales) values('Tmaxuser', '대한민국 S/W의 위상을 국내 및 전세계 시장에 알려나가고 있습니다.', '중견기업', 'SI/SM', 710);
