			...
			<section id="projects">
				<ul id="thumbs" class="portfolio">
					...
					<li class="col-lg-3 design" data-id="id-0" data-type="web">
						<div class="item-thumbs">
							...
							<a class="hover-wrap fancybox" data-fancybox-group="gallery"
								title="Work 1"
								href="${pageContext.request.contextPath}/resources/img/works/1.jpg">
					...
					<li class="item-thumbs col-lg-3 design" data-id="id-1"
						...
						title="Work 2"
						href="${pageContext.request.contextPath}/resources/img/works/2.jpg">
							<span class="overlay-img"></span> <span
							class="overlay-img-thumb font-icon-plus"></span>
					</a> <!-- Thumb Image and Description --> <img
						src="${pageContext.request.contextPath}/resources/img/works/2.jpg"
						alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis.">
					</li>
					<!-- End Item Project -->
					<!-- Item Project and Filter Name -->
					<li class="item-thumbs col-lg-3 photography" data-id="id-2"
						...
						class="hover-wrap fancybox" data-fancybox-group="gallery"
						title="Work 3"
						href="${pageContext.request.contextPath}/resources/img/works/3.jpg">
							<span class="overlay-img"></span> <span
							class="overlay-img-thumb font-icon-plus"></span>
					</a> <!-- Thumb Image and Description --> <img
						src="${pageContext.request.contextPath}/resources/img/works/3.jpg"
						alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis.">
					</li>
					<!-- End Item Project -->
					<!-- Item Project and Filter Name -->
					<li class="item-thumbs col-lg-3 photography" data-id="id-2"
						...
						class="hover-wrap fancybox" data-fancybox-group="gallery"
						title="Work 4"
						href="${pageContext.request.contextPath}/resources/img/works/4.jpg">
							<span class="overlay-img"></span> <span
							class="overlay-img-thumb font-icon-plus"></span>
					</a> <!-- Thumb Image and Description --> <img
