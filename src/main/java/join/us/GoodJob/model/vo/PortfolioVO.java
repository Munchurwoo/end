...
public class PortfolioVO {
    ...
    */
public PortfolioVO(String normalId, String content, String title, String picturePath, List<String> fileNameList,
		List<MultipartFile> fileList, List<LocCatVO> locCatVOList, List<RecruitCatVO> recruitCatVOList,
...
public String toString() {
	return "PortfolioVO [normalId=" + normalId + ", content=" + content + ", title=" + title + ", picturePath="
			+ picturePath + ", fileNameList=" + fileNameList + ", fileList=" + fileList + ", locCatVOList="
			+ locCatVOList + ", recruitCatVOList=" + recruitCatVOList + ", empTypeCatVOList=" + empTypeCatVOList
			+ ", devCatVOList=" + devCatVOList + ", acaCatVOList=" + acaCatVOList + ", locCatNumList=" + locCatNumList
			+ ", recruitCatNumList=" + recruitCatNumList + ", empTypeCatNumList=" + empTypeCatNumList
			+ ", devCatNumList=" + devCatNumList + ", acaCatNumList=" + acaCatNumList + "]";
}
