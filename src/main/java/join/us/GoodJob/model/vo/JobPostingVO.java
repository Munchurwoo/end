...
public class JobPostingVO {
	 ...
	 * @param contents 공고 내용(String) ex) 함께할 가족같은 인재를 모십니다
	...
	* @param locCatVOList 지역분류 리스트(VO,출력용)
	 ...
	 */
	public JobPostingVO(int jobPostingNum, String companyId, String careerStatus, String contents,
	...
	public String toString() {
		return "JobPostingVO [jobPostingNum=" + jobPostingNum + ", companyId=" + companyId + ", careerStatus="
				+ careerStatus + ", contents=" + contents + ", questionAnswerVOList=" + questionAnswerVOList
